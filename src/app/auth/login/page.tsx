    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-bg items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-12">
          ...
          <h2 className="text-3xl font-bold mb-4">Bienvenue sur Leo AI</h2>
          <p className="text-white/80 text-lg leading-relaxed">
            Ton assistant d&apos;étude intelligent. Connecte-toi pour accéder à tes cours et continuer à apprendre.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full gradient-bg text-white py-3.5 rounded-xl font-semibold hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-primary-500/25"
            >
